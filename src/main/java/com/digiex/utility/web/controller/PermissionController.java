...
public class PermissionController {
    ...
    public ResponseEntity<PermissionDTO> updateRole(@PathVariable int id, @RequestBody PermissionDTO updatedPermissionDTO) {
        Optional<PermissionDTO> existingPermission = permissionServiceImp.getPermissionById(id);
        if (existingPermission.isPresent()) {
            PermissionDTO updatedPermission = permissionServiceImp.updatePermission(id, updatedPermissionDTO);
